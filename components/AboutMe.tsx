...
const AboutMe = () => {
  return (
    <div className="h-[1200px] bg-[url('/BodyTier.png')] bg-[50%_40%] bg-no-repeat bg-cover">
      <div className="flex flex-col justify-around md:justify-center items-center h-full">
        ...
        <div className="flex items-center justify-center basis-1/5 md:relative md:top-60 flex-col md:flex-row">
